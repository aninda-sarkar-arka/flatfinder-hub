        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              FlatFinder helps you find the perfect rental property that meets your needs, with thousands of verified listings from trusted owners.
            </p>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Subscribe to our newsletter to get the latest updates on new properties and offers.
            </p>
